...
public class ConvertSortedArrayToBinarySearchTreeTest {
    ...
    void testOne() {
        ...
        Assertions.assertEquals("[1]", TreeUtils.inOrderList(root).toString());
    ...
    void testTwo() {
        int[] nums = { 1, 3 };
        TreeNode root = searchTree.sortedArrayToBST(nums);
        Assertions.assertEquals("[1, 3]", TreeUtils.inOrderList(root).toString());
        root = searchTree.sortedArrayToBST(nums, 0, nums.length - 1);
        Assertions.assertEquals("[1, 3]", TreeUtils.inOrderList(root).toString());
    }
    ...
    void testThree() {
        int[] nums = { 1, 2, 3 };
        TreeNode root = searchTree.sortedArrayToBST(nums);
        Assertions.assertEquals("[1, 2, 3]", TreeUtils.inOrderList(root).toString());
        root = searchTree.sortedArrayToBST(nums, 0, nums.length - 1);
        Assertions.assertEquals("[1, 2, 3]", TreeUtils.inOrderList(root).toString());
    }
    ...
    void testMore() {
        int[] nums = { -10, -3, 0, 5, 9 };
        TreeNode root = searchTree.sortedArrayToBST(nums);
        Assertions.assertEquals("[-10, -3, 0, 5, 9]", TreeUtils.inOrderList(root).toString());
        root = searchTree.sortedArrayToBST(nums, 0, nums.length - 1);
        Assertions.assertEquals("[-10, -3, 0, 5, 9]", TreeUtils.inOrderList(root).toString());
    }
}
