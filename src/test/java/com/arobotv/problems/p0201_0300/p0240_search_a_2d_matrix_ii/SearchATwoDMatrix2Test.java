...
public class SearchATwoDMatrix2Test {
    ...
    void testSearchMatrix3() {
        int matrix[][] = { { 1, 4, 7, 11, 15 }, { 2, 5, 8, 12, 19 }, { 3, 6, 9, 16, 22 }, { 10, 13, 14, 17, 24 },
                { 18, 21, 23, 26, 30 } };
        Assertions.assertTrue(searchATwoDMatrix2.searchMatrix2(matrix, 5));
        Assertions.assertFalse(searchATwoDMatrix2.searchMatrix2(matrix, 25));
    }
    @Test
    void testSearchMatrix4() {
        int matrix[][] = { { 1, 4}, { 2, 5 } };
        Assertions.assertTrue(searchATwoDMatrix2.searchMatrix2(matrix, 5));
    }
}
